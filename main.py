...
# ===================== Load the Dataset =====================
df = pd.read_csv('items-to-test.csv')
...
dump(best_model, 'model-build-from-scrap-data.pkl')
print(f"Best model saved as 'model-build-from-scrap-data.pkl' ({type(best_model).__name__}).")
